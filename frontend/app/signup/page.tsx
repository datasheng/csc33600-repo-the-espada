    ...
    return (
        ...
        <form>
            <div className="flex flex-col items-center">
                <h1 className="text-2xl">What kind of user are you?</h1>
                <button onClick={toggleDropdown} className='rounded' type="button">
                    {selectedOption ? selectedOption : 'Role'}
                    {showDropdown && (
                    <ul>
                        <li onClick={() => handleOptionClick('Consumer')}>Consumer</li>
                        <li onClick={() => handleOptionClick('Business')}>Business</li>
                    </ul>)}
                </button>
                        ...
                        <div className=" relative bg-black/70 text-black border-yellow-400 border-10 px-14 py-8 rounded-lg border border-solid  border-10">
                            ...
                            <form action="/login" method="POST">
                                <div className="mb-4">
                                    ...
                                    <input type="text" className="border border-solid border-grey w-full text-black" required></input>
                                </div>
                                <div className="mb-4">
                                ...
                                <div className="mb-4">
                                    ...
                                    <input type="email" className="border border-solid border-grey w-full text-black" required></input>
                                </div>
                                <div className="mb-4">
                                    <label className="block mb-2">Password</label>
                                    <input type="password" className="border border-solid border-grey w-full text-black" required></input>
                                </div>
